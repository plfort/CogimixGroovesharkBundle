<?php
namespace Cogipix\CogimixGroovesharkBundle\lib\Grooveshark;
/**
...
class gsAPI{
	...
	public static $ws_key;
	public static $ws_secret;
	protected $session;
	...
	*/
	protected static function apiCall($method, $args=array(), $https=true){
